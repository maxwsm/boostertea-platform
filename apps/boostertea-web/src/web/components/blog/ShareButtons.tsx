...
export function ShareButtons({ articleSlug, title, url, className = '' }: ShareButtonsProps) {
  ...
  return (
    <div className={className}>
      <p className="text-white font-mono text-xs uppercase tracking-widest mb-4 opacity-50">Поділитися:</p>
      <div className="flex flex-wrap gap-2">
        ...
        <button
          ...
          className={`
            ...
            ${copied 
              ? 'bg-[#22D3A5]/20 text-[#22D3A5] border-[#22D3A5]/50 shadow-[0_0_15px_rgba(34,211,165,0.2)]' 
