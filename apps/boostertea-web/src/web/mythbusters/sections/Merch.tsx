...
import { accessoryProducts } from '@wsm/config';
...
export default function Merch() {
  ...
  const merchItems = accessoryProducts
    .filter((p: any) => p.subcategory === 'dry_tea' || p.subcategory === 'apparel' || p.subcategory === 'stickers')
    .map((p: any) => ({
      id: p.id,
  ...
  const filteredItems = activeCategory === 'all' 
    ? merchItems 
    : merchItems.filter((item: any) => item.category === activeCategory);
