...
const SITE_NAME = 'DinoSlush'

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: 'DinoSlush — Натуральні дитячі слаші',
    template: '%s | ' + SITE_NAME,
  },
  description: 'DinoSlush — корисні фруктові слаші без цукру для дітей. Яскраві смаки, натуральний склад.',
  keywords: ['слаш', 'дитячі напої', 'dinoslush', 'фруктовий лід', 'натуральний слаш'],
  authors: [{ name: SITE_NAME, url: SITE_URL }],
  alternates: { canonical: SITE_URL },
  openGraph: {
    title: 'DinoSlush — Дитяча радість',
    description: 'Фруктові натуральні слаші для дітей.',
    url: SITE_URL,
    siteName: SITE_NAME,
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "description": "Виробник дитячих натуральних напоїв",
