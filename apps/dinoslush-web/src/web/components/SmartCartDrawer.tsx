                  ...
                  {isB2B ? (
                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-3">
                        <button onClick={() => { handleClose(); window.location.href='/checkout'; }} className="bg-black border border-white/10 text-white font-bold py-3.5 rounded-xl hover:bg-white/5 hover:border-white/30 transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95">
                        ...
                        <button onClick={() => { handleClose(); window.location.href='/checkout'; }} className="bg-white border border-transparent text-black font-bold py-3.5 rounded-xl hover:bg-white/90 transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95">
