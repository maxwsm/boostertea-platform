...
export default function BlogPost({ slug: propSlug, meta: propMeta, toc: propToc, children }: BlogPostProps) {
  ...
  const slug = propSlug || routerParams?.slug || 'unknown';

  const meta = propMeta || getPostBySlug(slug) || ({
    title: 'Loading...',
    slug: slug,
