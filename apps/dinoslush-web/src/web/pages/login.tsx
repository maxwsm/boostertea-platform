...
const Login = () => {
  return (
    <div className="min-h-screen bg-[var(--bg-primary)] flex flex-col relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-bl from-[#ff6b6b]/20 to-transparent rounded-full blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-gradient-to-tr from-[#4ecdc4]/20 to-transparent rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="max-w-md mx-auto px-4 w-full">
          ...
          <div className="bg-white/5 backdrop-blur-xl border border-white/20 rounded-3xl p-8 mb-8 text-center shadow-2xl relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <div className="w-16 h-16 bg-gradient-to-tr from-[#ff6b6b] to-[#4ecdc4] rounded-2xl rotate-12 flex items-center justify-center mb-6 shadow-xl shadow-[#ff6b6b]/20">
              ...
              <h2 className="text-2xl font-bold text-[var(--text-primary)] mb-2 tracking-tight">Ввійти в DinoSlush</h2>
              <p className="text-[var(--text-primary)]/var(--text-muted) text-sm mb-8 leading-relaxed">
                Доступ до порталу дитячої радості відтепер переведено на Telegram задля абсолютної безпеки та відмови від паролів.
              </p>
          ...
          <p className="text-center text-[var(--text-primary)]/var(--text-muted)">
            <Link href="/" className="text-[#ff6b6b] font-medium hover:text-[#ff5252] transition-colors inline-flex items-center gap-2 group">
              <span className="w-6 h-6 rounded-full bg-[#ff6b6b]/10 flex items-center justify-center group-hover:bg-[#ff6b6b]/20 transition-colors">
