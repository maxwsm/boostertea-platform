              ...
              <div>
                ...
                <div className="mb-6">
                  <button
                    ...
                    className="w-full py-4 bg-gradient-to-r from-[var(--accent)] to-[#D4A57A] text-[var(--bg-primary)] text-lg font-bold rounded-xl hover:shadow-[0_0_25px_rgba(196,149,106,0.35)] transition-all active:scale-[0.98] flex items-center justify-center gap-3 relative overflow-hidden group"
                  >
                    <div className="absolute inset-0 bg-white/20 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-out"></div>
                    <span className="relative z-10">{t('productDetail.addToCart')}</span>
