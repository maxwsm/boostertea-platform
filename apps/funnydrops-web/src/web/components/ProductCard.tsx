  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        {/* 360° UX: Gen-Z / Kids FUN Metrics */}
        <div className="mb-4 space-y-3 p-3 rounded-2xl bg-[#0B0033]/40 border-2 border-[#FF1053]/30">
          <div className="flex flex-col gap-1">
            <div className="flex justify-between text-[11px] uppercase text-[#FFEA00] font-black tracking-wider">
              <span>Fun Factor 🎢</span>
              <span className="text-[#00FFAA]">100%</span>
            </div>
            <div className="h-3 w-full bg-[#150050] rounded-full overflow-hidden border border-[#FFEA00]/30 relative mix-blend-screen">
              <div 
                className="h-full bg-gradient-to-r from-[#FF1053] to-[#00FFAA] rounded-full animate-shimmer" 
                style={{ width: '100%' }}
              />
            </div>
          </div>
          <div className="flex flex-col gap-1">
            <div className="flex justify-between text-[11px] uppercase text-[#FFEA00] font-black tracking-wider">
               ...
               <span className="text-[#FF1053]">MAX</span>
            </div>
            <div className="h-3 w-full bg-[#150050] rounded-full overflow-hidden border border-[#FF1053]/30">
               <div className="h-full bg-[linear-gradient(45deg,#FF1053_25%,#CC0066_25%,#CC0066_50%,#FF1053_50%,#FF1053_75%,#CC0066_75%,#CC0066_100%)] bg-[length:20px_20px] animate-[shimmer_2s_linear_infinite] rounded-full" style={{ width: '100%' }} />
            </div>
          </div>
        </div>
        ...
        <div className={`mt-5 flex flex-col gap-3 ${isPreRelease ? 'opacity-50 pointer-events-none grayscale' : ''}`}>
          ...
          {/* Fun B2C Focus (Hidden B2B ROI Calculator) */}
          <div className="mt-3 p-3 rounded-xl bg-[#FF1053]/10 border border-[#FF1053]/30 flex flex-col gap-2 relative overflow-hidden">
            <div className="absolute top-0 right-0 p-1 opacity-20 text-4xl">✨</div>
            <div className="flex justify-between items-center text-sm font-bold z-10 w-full">
              <span className="text-[#00FFAA]">Магія в кожній порції:</span>
              <span className="text-[#FFEA00] text-xl drop-shadow-[0_0_5px_rgba(255,234,0,0.8)] tabular-nums">{portionsCount} порцій!</span>
            </div>
            <div className="flex justify-between items-center text-xs font-bold border-t border-[#FF1053]/20 pt-2 z-10 w-full text-white/80">
              <span>Створюй настрій кожен день! 🧪</span>
            </div>
          </div>
        </div>
