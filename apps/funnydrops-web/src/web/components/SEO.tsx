...
const BASE_URL = 'https://www.tai-drink.com.ua';
...
const organizationSchema = {
  ...
  '@type': 'Organization',
  name: 'Funny Drops',
  alternateName: 'Funny Drops Ukraine',
  url: BASE_URL,
  logo: `${BASE_URL}/assets/funny drops black.png`,
  description: 'Funny Drops — сиропи без цукру. Яскраві смаки для різдвяних моментів і особливих свят.',
  foundingDate: '2023',
  foundingLocation: {
    '@type': 'Place',
    address: {
...
export const seoConfigs = {
  home: {
    uk: {
      title: 'Сиропи без цукру від Funny Drops',
      description: 'Funny Drops – яскраві смаки для різдвяних моментів і особливих свят. Ідеальні для кав\'ярень, кондитерських та домашнього вжитку.'
    },
    en: {
      title: 'Sugar-free syrups by Funny Drops',
      description: 'Funny Drops — premium sugar-free syrups. Perfect for coffee shops, bakeries, and home.'
    },
    es: {
      title: 'Jarabes sin azúcar de Funny Drops',
      description: 'Funny Drops — jarabes sin azúcar premium. Perfectos para cafeterías y el hogar.'
    }
  },
  products: {
    uk: {
      title: 'Каталог сиропів | Funny Drops',
      description: 'Асортимент крафтових сиропів без цукру. Створюй шедеври з нашими яскравими смаками.'
    },
    en: {
      title: 'Syrups Catalog | Funny Drops',
      description: 'Catalog of craft sugar-free syrups. Create masterpieces with our vibrant flavors.'
    },
    es: {
      title: 'Catálogo de Jarabes | Funny Drops',
      description: 'Catálogo de jarabes artesanales sin azúcar. Crea obras maestras con nuestros sabores vibrantes.'
    }
  },
  accessories: {
    uk: {
