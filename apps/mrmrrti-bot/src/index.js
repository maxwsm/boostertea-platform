...
bot.action('about', (ctx) => {
  ctx.answerCbQuery();
  ctx.replyWithMarkdownV2(`
\\[ *ПРО СИСТЕМУ: I³\\.MRMRRT\\.ƐI* \\]

Ваш персональний ШІ\\-стратег\\. Допомагає приймати правильні рішення, коли емоції заважають думати\\.

\\[ *ЩО ВМІЄ ДОДАТОК* \\]:
▪️ Знаходить "сліпі зони" у ваших конфліктах та проблемах\\.
▪️ Визначає, який з 8 Тіньових Архетипів вами зараз керує\\.
▪️ Дає готові стратегії від топових компаній \\(Tesla, Google, NASA\\)\\.
▪️ Пояснює складну психологію простою мовою\\.
▪️ Містить аудіо\\-терапію для відновлення фокусу\\.

\\[ *УВАГА* \\]: Система не є медичним інструментом\\. Це інструмент для глибокого самоаналізу\\.
  `.trim());
});
