...
export async function GET() {
  try {
    ...
    const domain = 'https://tlab.com.ua';
...
<rss version="2.0" xmlns:g="http://base.google.com/ns/1.0">
  <channel>
    <title>TLab - Facebook Catalog</title>
    <link>${domain}</link>
    <description>Офіційний каталог продукції TLab для Meta Ads</description>
${itemsXml}
  </channel>
</rss>`;
