...
const SITE_NAME = 'T-Lab'

export const metadata: Metadata = {
  metadataBase: new URL(SITE_URL),
  title: {
    default: 'T-Lab — Професійні чайні концентрати для HoReCa',
    template: '%s | ' + SITE_NAME,
  },
  description: "T-Lab — преміальні чайні концентрати для кафе, ресторанів та кав'ярень. Оптимізація бару та стабільний смак.",
  keywords: ['tlab', 'чай', 'чайні концентрати для бізнесу', 'чай для кафе', 'tai-drink'],
  authors: [{ name: SITE_NAME, url: SITE_URL }],
  alternates: { canonical: SITE_URL },
  openGraph: {
    title: 'T-Lab — Еволюція чайного бару',
    description: 'Екстракти натурального чаю для бізнесу.',
    url: SITE_URL,
    siteName: SITE_NAME,
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                "description": "B2B постачальник чайних концентратів",
