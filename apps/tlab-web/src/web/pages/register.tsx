        ...
        <div className="w-full max-w-sm">
          ...
          <div className="border border-white/10 bg-[#0a0a0a]/80 backdrop-blur-md p-10 relative group">
            ...
            <div className="flex flex-col items-center">
              <div className="w-12 h-12 border border-white/20 bg-white/5 flex items-center justify-center mb-8">
              ...
              <h2 className="text-xl uppercase tracking-widest text-white mb-3">T-Lab / РЕЄСТРАЦІЯ</h2>
              <div className="w-full h-px bg-[#0088cc]/30 mb-6" />
              <p className="text-white/60 text-xs mb-10 leading-relaxed text-center uppercase tracking-wider">
                Створити b2b обліковий запис T-Lab можливо лише за допомогою підтвердження через офіційного Telegram-бота.
              </p>

              <a href="https://t.me/boostertea_bot" target="_blank" rel="noreferrer" className="w-full flex items-center justify-between border border-white/30 bg-white/5 hover:bg-white hover:text-black text-white transition-all px-6 py-4 uppercase text-xs tracking-widest group">
                <span>Ідентифікація</span>
                <span className="font-bold opacity-50 group-hover:opacity-100">&gt;&gt;</span>
              </a>
            </div>
          </div>
