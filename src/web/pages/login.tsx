                ...
                <label className="flex items-center gap-2 cursor-pointer group">
                  <div className="relative">
                    <input
                      ...
                      className="sr-only"
                    />
                    <div className={`w-5 h-5 rounded border-2 transition-all ${rememberMe ? 'bg-[var(--accent)] border-[#9FD356]' : 'border-[#F5F0E8]/30 group-hover:border-[var(--card-border)]0'}`}>
                      {rememberMe && (
                  ...
                  <span className="text-[var(--text-primary)]/var(--text-muted) text-sm">{t('login.rememberMe')}</span>
                </label>
                <button type="button" className="text-[var(--accent)] text-sm hover:underline">
            ...
            <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-[var(--bg-primary)] text-[var(--text-primary)]/var(--text-subtle)">{t('login.or')}</span>
                </div>
              </div>
